...
class NearEarthObject:
    ...
    def __init__(self, **info):
        ...
        self.hazardous = True if info['hazardous'] == 'Y' or info['hazardous'] == True else False
    ...
    def __str__(self):
        ...
        return f"A NearEarthObject {self.fullname} has a diameter of {{diameter: {self.diameter:.3f}}} km and " \
                + (f"is " if self.hazardous else f"is not ") + "potentially hazardous."
...
class CloseApproach:
    ...
    def time_str(self):
        ...
        # TODO: Use self.designation and self.name to build a fullname for this object.
        self.approach_time = datetime_to_str(self.time)
